public class main {
    ...
    public static void main(String[] args) {
        ...
        DoubleLinkedList<Student> dl3 = new DoubleLinkedList();
        ...
        dl1.insertInOrder(5);
        dl1.insertInOrder(4);
        System.out.println("ADDED 5 4: " + dl1.toString());                       //should be 1 3 4 5
        dl1.delete(1);
        ...
        dl3.insertInOrder(new Student(5));
        dl3.insertInOrder(new Student(2));
        dl3.insertInOrder(new Student(3));
        System.out.println(dl3.toString());
        dl3.insertInOrder(new Student(1));
        dl3.insertInOrder(new Student(4));
        System.out.println(dl3.toString());
        ...
        DoubleLinkedList mergedList = DoubleLinkedList.sortedMerge(L1, L2);
        System.out.println("MERGED: " + mergedList.toString());

        DoubleLinkedList.append(L1, L2);
        System.out.println("L1: " + L1.toString());
        System.out.println("L2: " + L2.toString());
        ...
        L1.insertInOrder(5);
        System.out.println("L1: " + L1.toString());
        DoubleLinkedList.removeDuplicates(L1);
        System.out.println("Dupes removed: " + L1.toString());
